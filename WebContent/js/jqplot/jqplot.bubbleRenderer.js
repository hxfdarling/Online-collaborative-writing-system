     ...
     * > }
        ...
        $.jqplot.BubbleRenderer.prototype.draw = function (ctx, gd, options) {
            ...
            for (var i = 0; i < this.radii.length; i++) {
                ...
                this.bubbleCanvases[idx].draw(gd[2], color, this.bubbleGradients, this.shadowAngle / 180 * Math.PI, s);
        ...
        $.jqplot.BubbleCanvas.prototype.draw = function (r, color, gradients, angle, shape) {
            var ctx = this._ctx;
            // r = Math.floor(r*1.04);
